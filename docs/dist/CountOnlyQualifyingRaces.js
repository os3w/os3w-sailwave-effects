 ...
 * described at https://os3w.github.io/os3w-sailwave-effects#md:count-only-qualifying-races.
 *
...
n&&!n.classList.contains("summarytitle");)if(n.classList.contains("summarycaption"))o.caption=null!==(s=n.textContent)&&void 0!==s?s:"";else if(n.classList.contains("summarytable")){const t=(c=n,(new m).parse(c));r=t.raceCount,o.qualifiedCount=t.qualifiedCount,o.competitors=t.competitors}var c;return o.races=h(o,r),o})(t);s&&e.groups.push(s)})),e}}const k=e=>{const{competitors:s,races:n,qualifiedCount:r}=e;for(let e=0;e<n.length;++e){const c=n[e];if(!c.isSailed)continue;let a=!1;for(const n of s){a||n.rank===t||(a=!0);const s=o(n.results[e]);!1!==s&&("DNC"===s.code&&(s.score=Math.max(r,c.countCameToStart)+1))}a||(c.isSailed=!1)}};document.addEventListener("DOMContentLoaded",(()=>{const t=(e=document,(new C).parse(e));var e;for(const e of t.groups)k(e),c(e),p(e);(()=>{const t=document.querySelector(".seriestitle"),e=document.createElement("div")
;e.innerHTML="DNC scores and races sailed are provisional based on the number of qualifiers.<br><small>Rescored by Count Only Qualifying Races effect v1.0.2</small>",null==t||t.insertAdjacentElement("afterend",e)})()}))}();
//# sourceMappingURL=CountOnlyQualifyingRaces.js.map
