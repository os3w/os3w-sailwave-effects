...
// Main banner.
const bannerLines = ` * ${name} v${pkg.version} ${datetime}
 * ${pkg.homepage}
 ...
 * ${pkg.homepage}#md:result-modifying-effects.`;
 ...
 * ${pkg.homepage}#md:count-only-qualifiers
 *
${warning}
 *
${bannerLines}
 ...
 * described at ${pkg.homepage}#md:count-only-qualifying-races.
 *
${warning}
 *
${bannerLines}
