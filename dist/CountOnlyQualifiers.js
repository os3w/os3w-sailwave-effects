 ...
 * https://os3w.github.io/os3w-sailwave-effects#md:count-only-qualifiers
 *
...
n&&!n.classList.contains("summarytitle");)if(n.classList.contains("summarycaption"))o.caption=null!==(s=n.textContent)&&void 0!==s?s:"";else if(n.classList.contains("summarytable")){const t=(c=n,(new m).parse(c));r=t.raceCount,o.qualifiedCount=t.qualifiedCount,o.competitors=t.competitors}var c;return o.races=h(o,r),o})(t);s&&e.groups.push(s)})),e}}const N=t=>{const{competitors:e,races:s,qualifiedCount:n}=t;for(let t=0;t<s.length;++t){const r=s[t];if(r.isSailed)for(const s of e){const e=o(s.results[t]);!1!==e&&("DNC"===e.code&&(e.score=Math.max(n,r.countCameToStart)+1))}}};document.addEventListener("DOMContentLoaded",(()=>{const t=(e=document,(new C).parse(e));var e;for(const e of t.groups)N(e),c(e),p(e);(()=>{const t=document.querySelector(".seriestitle"),e=document.createElement("div");e.innerHTML="DNC scores are provisional based on the number of qualifiers.<br><small>Rescored by Count Only Qualifying Races effect v1.0.2</small>",null==t||t.insertAdjacentElement("afterend",e)})()}))
}();
//# sourceMappingURL=CountOnlyQualifiers.js.map
